...
<div class="container pb-5">
    ...
    if(!$res){
        ...
        <form method="POST" action="check_update_teacher.php?id=<?php echo $id ?>" onsubmit="return validation()">
            <?php
                if(isset($_GET['error'])){
                    $error=$_GET['error'];
            ...
            <div class="md-form from-group">
                <button type="submit" class="btn btn-primary" name="update_teacher">Submit</button>
            </div>
